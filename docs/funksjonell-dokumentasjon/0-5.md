...
- NAVs løsning for legeerklæring:pleiepenger (system) kjørende i infrastrukturen til helseforetak.
- NAVs løsning for legeerklæring:pleiepenger (system) kjørende i NAVs infrastruktur i offentlig sky (Google Cloud).
- Søker/omsorgsperson.
- NAVs løsning for saksbehandling av pleiepenger (system) kjørende i NAVs infrastruktur i offentlig sky (Google Cloud), og i NAvs datahaller.
- Veileder og saksbehandler i NAV.
